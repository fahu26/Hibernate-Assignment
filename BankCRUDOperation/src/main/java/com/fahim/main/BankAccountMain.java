...
public class BankAccountMain {
	...
	public static void main(String[] args) {
		...
		BankAccount account =  new BankAccount(102, "cxbbs", 5000.00,dateTime1,BankAccountType.CURRENT);
		BankAccount account1 =  new BankAccount(103, "dvsvsd", 100.00,dateTime2,BankAccountType.FIXED_DEPOSIT);
		BankAccount account2 =  new BankAccount(104, "dvdv", 100.00,dateTime2,BankAccountType.SAVING);
